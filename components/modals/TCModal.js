  ...
  return (
    ...
    >
      ...
      <Modal.Body className="modal-body">
        <p>
          Terms and Conditions for Membership with FashionPal
          <br></br>
          Please read these Terms and Conditions carefully before submitting
          your application for membership with the FashionPal. By submitting
          your application, you agree to be bound by these Terms and Conditions.
          ...
          FashionPal. However, you will not have access to sell or buy books
          until the approval process is complete. We reserve the right to refuse
          membership to any bookstore at our sole discretion.<br></br>
          Access to the FashionPal:<br></br>Upon approval of your membership,
          you will have access to the FashionPal&apos;s features. This access is
          non-transferable and intended solely for your use.<br></br>Listing and
          Selling Books:<br></br>
          As a member of the FashionPal, you will have the ability to list and
          sell books through the Network. You will be responsible for complying
          with all applicable laws and regulations related to the sale of books.
          We will not be liable for any violations committed by you.<br></br>
          Service Fees:<br></br>There is no fee associated with submitting an
          application for membership with the FashionPal. However, we reserve
          the right to charge service fees for the use of the Network. Any
          service fees will be clearly disclosed to you.<br></br>
          Listing Fees:
          ...
          FashionPal, including text, graphics, logos, images, and software, is
          the property of our company or its suppliers and protected by
          copyright laws. The content may not be used or reproduced without
          express written permission from us.<br></br>Limitation of Liability:
          <br></br>We will not be liable for any damages arising out of your
          membership with the FashionPal, including but not limited to lost
          profits, direct or indirect damages, or consequential damages.
          ...
          the competent courts in the United States of America.
          ...
          <br></br>
          <br></br>FashionPal Privacy Policy<br></br>At Buy Local Books Network,
          we are committed to protecting your privacy. This Privacy Policy
          outlines the types of information we collect, how we use that
          information, and your rights with respect to your personal
          information.<br></br>
          ...
          information collected through the FashionPal for the following
          purposes:<br></br>- To process your application for membership
