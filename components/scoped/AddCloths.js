                        ...
                        <div className="w-72 flex-shrink-0">
                                ...
                                <>
                                    {image.url ? (
                                        <div className="mt-8 border-2 border-black rounded-2xl px-4 py-10 w-64 relative">
                                            ...
                                            <button onClick={deleteImage} className="mt-4 bg-red-500 hover:bg-red-700 text-white font-bold py-1.5 absolute -top-2 right-2 z-10 px-1.5 rounded">
                                    ...
                                    <div className="mt-4">
                                        {step === 2 ?
                                            <ButtonComponent full onClick={() => handleAdd('main')} className={`!my-1 !w-64 rounded-lg  !text-black`}>Main Photo</ButtonComponent>
                                            : ''}
                                        {step === 3 ?
                                            <>
                                                <ButtonComponent full onClick={() => handleAdd('brandTag')} className={`!my-1 !w-64 rounded-lg !bg-green-600 !text-black`}>Brand Tag Photo</ButtonComponent>
                                                <ButtonComponent full onClick={() => setStep(4)} className={`!my-1 !w-64 rounded-lg !text-black`}>Skip Brand Tag</ButtonComponent>
                                            </>
                                            : ''}
                                    </div>
                                </>) : ''}
                            ...
                            {step === 4 ?
                                <>
                                    <div className="flex flex-wrap">
                                        {uploadedImages.main ?
                                            <div className=" p-2 w-56 bg-white rounded-xl m-1 relative">
                                                ...
                                                <button onClick={() => handleDelete('main')} className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 absolute top-2 right-2 z-10 px-1 rounded">
                                        ...
                                        {uploadedImages.brandTag ?
                                            <div className=" p-2 w-56 bg-white rounded-xl m-1 relative">
                                                ...
                                                <button onClick={() => handleDelete('brandTag')} className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 absolute top-2 right-2 z-10 px-1 rounded">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
                                                    </svg>
                                                </button>
                                    ...
                                    <ButtonComponent full onClick={() => handleListMore()} className={`!my-1 rounded-lg !bg-green-600 !text-black`}>List More</ButtonComponent>
                        ...
                        <div className="px-5 mt-6 w-full">
                                        ...
                                        <div className="flex flex-wrap">
                                            {row.items.main ?
                                                <div className=" p-2 w-56 bg-white rounded-xl m-1 relative">
                                                    ...
                                                    {/* <span className="bg-green-500 rounded-xl text-xs px-2 py-0.5 text-white">{row.items.main.tag}</span> */}
                                                    <button onClick={() => handleDelete('main')} className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 absolute top-2 right-2 z-10 px-1 rounded">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
                                                        </svg>
                                            ...
                                            {row.items.brandTag ?
                                                <div className=" p-2 w-56 bg-white rounded-xl m-1 relative">
                                                    ...
                                                    {/* <span className="bg-green-500 rounded-xl text-xs px-2 py-0.5 text-white">{row.brandTag.tag}</span> */}
                                                    <button onClick={() => handleDelete('brandTag')} className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 absolute top-2 right-2 z-10 px-1 rounded">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
                                                        </svg>
                            ...
                            {listings.length > 0 && (
                                <div className="mt-10 ml-3">
                                    ...
                                    <ButtonComponent rounded className="!w-48" onClick={setStep(6)} >Upload All</ButtonComponent>
                                </div>
                            )}
                        </div>
                        : ''}
                        ...
                        <div>
                            {listings.map((row, index) => (
                                <div key={index}>
                                    <div className="flex flex-wrap">
                                        {row.items.main ?
                                            <div className=" p-2 w-56 bg-white rounded-xl m-1 relative">
                                                ...
                                                {/* <span className="bg-green-500 rounded-xl text-xs px-2 py-0.5 text-white">{row.items.main.tag}</span> */}
                                                <button onClick={() => handleImageDeleteInListing(index, 'main')} className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 absolute top-2 right-2 z-10 px-1 rounded">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
                                                    </svg>
                                                </button>
                                        ...
                                        {row.items.brandTag ?
                                            <div className=" p-2 w-56 bg-white rounded-xl m-1 relative">
                                                ...
                                                {/* <span className="bg-green-500 rounded-xl text-xs px-2 py-0.5 text-white">{row.brandTag.tag}</span> */}
                                                <button onClick={() => handleImageDeleteInListing(index, 'brandTag')} className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 absolute top-2 right-2 z-10 px-1 rounded">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
                                                    </svg>
                                                </button>
                                    ...
                                    </div>
                                    {
                                        row.tags.map((tag, tagIndex) => (
                                            <div key={tagIndex} className="py-1 w-full items-center flex">
                                                ...
                                                <button onClick={() => handleDeleteTag(index, tagIndex)} className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-1 rounded">
                                    ...
                                    <button className=" bg-indigo-600 px-4 py-1.5 mt-2 rounded-lg text-white" onClick={() => handleAddTag(index)}>Add Tag</button>
                                </div>
                            ))}
                            <ButtonComponent rounded className="!w-48" onClick={triggerToListingOrEdit} >{editAfterUpload ? 'Next' : 'Upload All'}</ButtonComponent>
                        </div>
...

                    {
                        step === 7 ?
                            <>
                                            ...
                                            >
                                                <div className="flex">
                                                    ...
                                                    <div className="w-full mb-3 ">
                                                        ...
                                                        <button onClick={() => triggerEditTagsModal(index)} className="bg-[#FEDDBC] px-3 py-1 text-xs mt-1 rounded">
                                                            Edit Tags
                                                        </button>
                                                    </div>
                                                </div>
                                ...
                                <ButtonComponent rounded className="!w-48 mt-4" onClick={handleUploadAll} >Upload All</ButtonComponent>
                            </> : ''
                    }
                    {
                        tagEditModal ?
