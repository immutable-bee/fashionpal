          ...
          records: [
            {
              _base64: base64Image,
              prompt:
                "Please extract specific details from the provided text and create an array. Each entry in the array should consist of a name and its corresponding value. for example if image found brand or Made then should return this: {name: 'Made in', value: 'country here....'} {name: 'Brand', value: 'brand here.....'} ...",
            },
          ],
        },
        {
