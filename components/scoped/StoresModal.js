                    ...
                    >
                        ...
                        <div className="sm:flex flex-wrap justify-center mt-2">
                            {listings.map((row, key) => {
                                return (
                                    <div key={key} className="border border-gray-300 m-2 w-48 rounded-xl p-[11px]">
                                        <div>
                                            <div>
                                            ...
                                            <div>
                                                <div className="flex justify-between items-center mt-[12px]">
                                                    ...
                                                    <DeleteModalComponent title='Are you sure you want to delete store?' onConfirmed={() => onDeleteStore(key)}>
