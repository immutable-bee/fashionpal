            ...
            <SwiperSlide key={key} className="border border-gray-300 h-96 rounded-xl p-[11px]">
              <div>
                ...
                <div className="flex items-center justify-between w-36 pr-2 mt-1 mx-auto">
                  <button onClick={(e) => toggleLike(key, e)} className="hover:bg-yellow-200 cursor-pointer hover:opacity-90 w-16 h-16 rounded-full flex items-center justify-center">
                  ...
                  <button onClick={(e) => toggleUnLike(key, e)} className="hover:bg-green-200 cursor-pointer hover:opacity-90 w-16 h-16 rounded-full flex items-center justify-center">
