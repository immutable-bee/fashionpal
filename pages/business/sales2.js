            ...
            <div className="py-2">
              ...
              <div className="relative">
                ...
                <svg
                  ...
                  strokeWidth="1.5"
                  stroke="currentColor"
                  className="w-6 h-6 absolute right-3 top-3 pointer-events-none"
                >
                  <path
                    strokeLinecap="round"
            ...
            <div className="py-2 w-full">
              ...
              <div className="relative">
                ...
                <svg
                  ...
                  strokeWidth="1.5"
                  stroke="currentColor"
                  className="w-6 h-6 absolute right-3 top-3 z-0 pointer-events-none"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
        ...
        {loadingCurrentSales ? (
          ...
          <div>
            {currentSales && currentSales?.length !== 0 ? (
                  ...
                  return (
                    ...
                    >
                      <DeleteModalComponent
                        title="Are you sure you want to delete sale?"
                        onConfirmed={() => alert("not integrated yet")}
                      >
                      ...
                      <div
                        className={`text-gray-800 font-light bg-white rounded px-2 py-1 w-full flex text-base leading-5 !mt-1.5`}
                      >
                        <span className="w-1/2">Type of items on sale:</span>{" "}
                      ...
                      >
                        ...
                        <span className="w-1/2">{row.discount_amount}</span>
                      </div>
                      <div
                        className={`text-gray-800 font-light bg-white rounded px-2 py-1 w-full flex text-base leading-5 !mt-1.5`}
                      >
              ...
              <h3 className="text-center text-lg mt-5">No Current Sales</h3>
            )}
          </div>
        )}
      </div>
        ...
        {loadingUpcomingSales ? (
          ...
          <div>
            {upcomingSales?.length !== 0 ? (
              ...
              <h3 className="text-center text-lg mt-5">No Upcoming Sales</h3>
            )}
          </div>
        )}
      </div>
