                        ...
                        <div className="px-2">
                            ...
                            <a href="bookstoreseattle.com" className="font-normal flex text-sm text-sky-500 my-2 mb-0">
                                <div className="w-6 flex-shrink-0">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 -ml-0.5 stroke-sky-500" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
