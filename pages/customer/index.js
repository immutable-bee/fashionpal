                          ...
                          <SwiperSlide key={index} className="!w-64">
                            ...
                            >
                              ...
                              <div className="flex items-center justify-between w-40 pr-2 mt-6 mb-3 mx-auto">
                                <button onClick={(e) => toggleLike(index, e)} className="hover:bg-yellow-200 cursor-pointer hover:opacity-90 w-16 h-16 rounded-full flex items-center justify-center">
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class={`w-12 h-12 ${row.isLiked ? 'text-yellow-600' : ''}`}>
                                ...
                                <button onClick={(e) => toggleUnLike(index, e)} className="hover:bg-green-200 cursor-pointer hover:opacity-90 w-16 h-16 rounded-full flex items-center justify-center">
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class={`w-12 h-12 ${row.isUnLiked ? 'text-green-600' : ''}`}>
