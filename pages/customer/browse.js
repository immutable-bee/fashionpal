                ...
                <div className="">
                  ...
                  >
                    ...
                    {listings.map((row, key) => {
                      return (
                        <SwiperSlide key={key} onClick={() => triggerDetailsModal(key)} className="border sm:!w-72 border-gray-300 cursor-pointer hover:bg-gray-50 sm:h-96 rounded-xl p-[11px]">
                          <div>
                            <div>
                              <div className="">
                                <Image
