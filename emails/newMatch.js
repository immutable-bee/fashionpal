                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td style="padding-bottom: 5px; width: 250px;" width="250">
                                                      <img alt="Buy local books network logo" height="auto" src="{{logo}}" style="border:0;display:block;outline:none;text-decoration:none;height:auto;font-size:13px;" width="250">
                                                    </td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                  ...
                                  <td style="padding-bottom: 5px; direction: ltr; font-size: 0px; padding: 0px; text-align: center;" align="center">
                                    ...
                                    <div className="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                        <tbody>
                                          <tr>
                                            <td style="padding-bottom: 5px; vertical-align: top; padding: 30px 0px;" valign="top">
                                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                                                <tbody>
                                                  <tr>
                                                    <td align="center" style="padding-bottom: 5px; font-size: 0px; padding: 0px; word-break: break-word;">
                                                      <div style="font-family:Poppins, sans-serif;font-size:28px;font-weight:700;line-height:120%;text-align:center;color:#74A57F;">{{title}}</div>
                                                    </td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" style="font-size: 0px; padding: 0px; padding-bottom: 20px; word-break: break-word;">
                                              <div style="font-family:Poppins, sans-serif;font-size:20px;font-weight:600;line-height:160%;text-align:center;color:#333333;">Hi, {{user}}</div>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="center" style="font-size: 0px; padding: 0px; padding-top: 20px; padding-bottom: 10px; word-break: break-word;">
                                              <div style="font-family:Poppins, sans-serif;font-size:14px;line-height:160%;text-align:center;color:#333333;">{{content}}</div>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                                            ...
                                            <td style="padding-bottom: 5px; direction: ltr; font-size: 0px; padding: 5px; text-align: center;" align="center">
                                              ...
                                              <div className="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                  <tbody>
                                                    <tr>
                                                      <td style="padding-bottom: 5px; vertical-align: top; padding: 24px 0 0;" valign="top">
                                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                                                          <tbody>
                                                            <tr>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:120px;line-height:100%;">
                                                                  <tr>
                                                                    <td align="center" bgcolor="#FFC71F" role="presentation" style="padding-bottom: 5px; border: 1px solid black; border-radius: 24px; cursor: auto; height: 30px; mso-padding-alt: 0; background: #FFC71F;" valign="middle" height="30">
                                                                      <a href="{{cta1}}" style="display: inline-block; width: 118px; background: #FFC71F; color: #333333; font-family: Poppins, sans-serif; font-size: 12px; font-weight: 500; line-height: 100%; margin: 0; text-decoration: none; text-transform: none; padding: 0; mso-padding-alt: 0px; border-radius: 24px;" target="_blank"> VIEW MATCHES </a>
                                                                    </td>
                                                                  </tr>
                                                                </table>
                                                              </td>
...
const newMatchEmail = { compiledHtml: compiledHtml };
